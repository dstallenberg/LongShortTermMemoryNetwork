package com.dimitri.lstmn.neural;

import com.dimitri.lstmn.neural.cells.HiddenCell;
import com.dimitri.lstmn.neural.layers.HiddenLayer;
import com.dimitri.lstmn.neural.layers.InputLayer;
...
public class Net {
    ...
    public void backPropogation(double[] targetOuput){
        ...
        for (int i = 0; i < outputLayer.getCell().length; i++) {
            ((HiddenCell)outputLayer.getCell(i)).calcOutputGradient(targetOuput[i]);
        }
